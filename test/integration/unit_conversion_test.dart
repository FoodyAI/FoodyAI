...
void main() {
  group('Unit Conversion Integration Tests', () {
    testWidgets('Complete unit conversion workflow',
      ...
      // Should show Measurement Units section
      ...
      // Verify conversion to imperial
      expect(find.text('Imperial (lbs, ft)'), findsOneWidget);
      ...
      // Verify conversion to metric
      expect(find.text('Metric (kg, cm)'), findsOneWidget);
      expect(find.byIcon(Icons.check_circle), findsOneWidget);
    });

    testWidgets('Unit conversion with different user profiles',
        (WidgetTester tester) async {
      // Test unit conversion with different user profiles
      final userProfiles = [
        {
          'gender': 'Male',
          'age': 25,
    ...
    testWidgets('Unit conversion with different screen sizes',
        (WidgetTester tester) async {
      // Test unit conversion on different screen sizes
      final screenSizes = [
    ...
    testWidgets('Unit conversion with different themes',
        (WidgetTester tester) async {
      // Start the app and complete onboarding
      app.main();
      await tester.pumpAndSettle();
      ...
      // Test unit conversion with light theme
      ...
      // Test unit conversion with dark theme
    ...
    testWidgets('Unit conversion with different app states',
        (WidgetTester tester) async {
      // Test unit conversion with different app states
      final appStates = [
        'onboarding',
        'home',
        'analyze',
      ...
      for (final state in appStates) {
        ...
        // Test unit conversion based on state
        if (state == 'settings') {
          ...
          // Navigate to settings and test unit conversion
          await tester.tap(find.text('Settings'));
          await tester.pumpAndSettle();
    ...
    testWidgets('Unit conversion with different network states',
        (WidgetTester tester) async {
      // Test unit conversion with different network states
      final networkStates = [
        'online',
        'offline',
        'slow_connection',
      ...
      for (final networkState in networkStates) {
        ...
        // Test unit conversion with this network state
    ...
    testWidgets('Unit conversion with different user states',
        (WidgetTester tester) async {
      // Test unit conversion with different user states
      final userStates = [
        'guest',
        'authenticated',
        'onboarding_complete',
      ...
      for (final state in userStates) {
        ...
        if (state == 'onboarding_incomplete') {
          ...
          // Should be on main app with unit conversion
          await tester.tap(find.text('Profile'));
          await tester.pumpAndSettle();
          await tester.tap(find.text('Settings'));
          await tester.pumpAndSettle();
    ...
    testWidgets('Unit conversion with different screen orientations',
        (WidgetTester tester) async {
      // Start the app and complete onboarding
      app.main();
      await tester.pumpAndSettle();
      ...
      // Test unit conversion in portrait orientation
      ...
      // Test unit conversion in landscape orientation
    ...
    testWidgets('Unit conversion with different app themes',
        (WidgetTester tester) async {
      // Start the app and complete onboarding
      app.main();
      await tester.pumpAndSettle();
      ...
      // Test unit conversion with system theme
      ...
      for (final state in appStates) {
        ...
        switch (state) {
          ...
          case 'error':
            ...
            // and testing unit conversion from error state
            break;
          case 'offline':
            // Simulate offline state
            // This would involve testing unit conversion
